...
|------------|---------------|-----------|---------|
| **GET** | Read | Obter recurso(s) | `GET /api/vehicles` |
| **POST** | Create | Criar novo recurso | `POST /api/vehicles` |
| **PUT** | Update | Atualizar recurso completo | `PUT /api/vehicles/123` |
| **DELETE** | Delete | Remover recurso | `DELETE /api/vehicles/123` |
...
### 2.1 Organização em Módulos (Yii2)
```
backend/modules/api/
├── ModuleAPI.php          # Configuração do módulo
├── controllers/           # Controladores REST
│   ├── VehicleController.php
│   ├── UserController.php
│   └── MessageController.php
└── components/           # Componentes customizados
    └── CustomAuth.php    # Autenticação personalizada
```
