...
$this->params['breadcrumbs'][] = ['label' => 'Rota #' . $model->id, 'url' => ['view', 'id' => $model->id]];
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= \yii\helpers\Url::to(['view', 'id' => $model->id]) ?>">Rota #<?= $model->id ?></a></li>
                ...
                <div class="col-lg-10 col-xl-8">
                    <div class="card card-warning card-outline" style="box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                        <div class="card-header">
                            <h3 class="card-title">
                                <i class="fas fa-route mr-2"></i>Editar Rota #<?= $model->id ?>
                            </h3>
                        </div>
